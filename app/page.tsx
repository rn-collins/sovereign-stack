...
const nav: { id: View; label: string; eyebrow: string }[] = [
  { id: "meeting", label: "Short walkthrough", eyebrow: "00" },
...
const meetingSlides = [
  { label: "Observed context", title: "Purple Maiʻa has already built the technical embodiment.", body: "Its public work joins local compute, open models, edge hardware, place-based observation, and Indigenous approaches to technology. This analysis is not an attempt to explain sovereignty back to Purple Maiʻa.", proof: "Read from public material only—not permission, internal knowledge, contact of any kind, or a finding about current operations." },
  { label: "Possible constraint", title: "The open question is whether authority remains operational as systems change.", body: "A technical stack can be locally controlled while decisions about purpose, knowledge, custody, use, dissent, repair, and exit remain difficult to carry through the full lifecycle.", proof: "This is RN’s hypothesis, formed from public material alone. Purple Maiʻa has not seen it; were it ever shown, they might correct it, narrow it, identify existing work, or reject it." },
  ...
  { label: "Author’s standing", title: "RN translates governance into working legal-technical infrastructure.", body: "RN combines AI product building, evidence architecture, governance and legal research, learning design, neuroscience, and human-systems analysis, and builds editable tools rather than static reports. This is stated to locate the author of the analysis, not to solicit work.", proof: "Role boundary: any such role would be implementation architect working under designated authority—never Indigenous authority or the source of Hawaiian values." },
  { label: "Bounded engagement", title: "Any such work would begin with paid discovery, not a presumed pilot.", body: "A short engagement would confirm the real constraint, map standing and documentation boundaries, trace one non-sensitive scenario, and determine whether to stop, revise, continue discovery, or invite a separately chartered pilot. No engagement has been offered, requested, or discussed.", proof: "Illustrative container only: sponsor interview, preparation, one 90-minute co-design session, synthesis, and editable decision brief. Timing, participants, confidentiality, and fee would be matters for an agreement that has not been sought." },
  { label: "Open question", title: "Would this be a useful problem to define with the right people?", body: "No one at Purple Maiʻa has been asked to approve a framework, choose KILO, disclose protected knowledge, or authorize production. Nothing here has been put to them. The open question this analysis raises is whether governed discovery would create enough value to be worth scoping at all.", proof: "If the question were ever put, valid answers would include yes, revise, refer, not now, and stop." },
] as const;
  ...
  return <main>
    ...
    <section className="hero">
      <div className="hero-copy">
        ...
        <p className="lede">An independent sketch of a community-owned way to carry purpose, authority, knowledge boundaries, accountability, and the right to refuse through the life of an AI system—read against Purple Maiʻa’s public work, and shown to no one there.</p>
        <div className="hero-actions"><button className="primary light" onClick={() => selectView("meeting")}>Read the 7-minute walkthrough <span>→</span></button><button className="text-link" onClick={() => selectView("review")}>Executive review</button></div>
      </div>
    ...
    <div className="scope-strip"><b>Unsolicited independent analysis. Not Purple Maiʻa policy, and not requested by them.</b><span>Written from public material alone; Purple Maiʻa has not been contacted, has not seen this, and has agreed to nothing. Were any of it ever taken up, Purple Maiʻa and the relevant community and cultural authorities would define the substance. This prototype only demonstrates a possible structure.</span></div>
    ...
    {view === "meeting" && <section id="meeting-content" className="content meeting-mode" tabIndex={-1}>
      <div className="meeting-top"><div><p className="overline">Short walkthrough · six steps · approximately seven minutes</p><h2>A short path through the full proposition.</h2></div><p>This is the condensed reading of the analysis. The complete product remains available in the numbered rooms as the evidence and working layer beneath it.</p></div>
    ...
    {view === "proposal" && <section id="proposal-content" className="content proposal" tabIndex={-1}>
      ...
      <div className="decision-box"><div><p className="overline">The open question this analysis leaves</p><h3>Is there a real governance or learning constraint here worth exploring at all?</h3></div><p>Nothing is being asked of anyone. Not approval of this prototype. Not permission to document KILO. If a first conversation ever happened, it would have to identify whether the problem is real, what existing work must not be duplicated, who else must be present, and whether a small discovery phase would be useful.</p></div>
    ...
    {view === "pilot" && <section id="pilot-content" className="content pilot" tabIndex={-1}>
      ...
      <div className="decision-box"><div><p className="overline">Possible first engagement</p><h3>A short, paid discovery and co-design phase—with a stop/go decision before any pilot.</h3></div><p>None of this has been proposed to Purple Maiʻa. Were it ever to be, scope, participants, duration, compensation, confidentiality, ownership terms, and deliverables would be defined only after Purple Maiʻa itself identified an actual need and the relevant authorities were invited into scope-setting.</p></div>
    </section>}
    ...
    {view === "session" && <section id="session-content" className="content session" tabIndex={-1}>
      ...
      <div className="decision-box"><div><p className="overline">The first question any such process would have to answer</p><h3>Is there a real governance or learning constraint worth exploring—and who should be in the room to define it?</h3></div><p>Not whether to approve this framework. Not whether KILO becomes the pilot. Not whether a backend should be activated. The first question would simply be whether a properly scoped, appropriately governed discovery process would be useful at all. Purple Maiʻa has not been asked it.</p></div>
    </section>}
    ...
    {view === "review" && <section id="review-content" className="content executive-review" tabIndex={-1}>
      <div className="section-intro compact"><p className="overline">Executive review · the whole proposition in one room</p><h2>Would there be enough here to justify a governed discovery conversation?</h2><p>This is the shortest path through the analysis, and an illustration of how a reviewer could respond to it. It asks nothing of Purple Maiʻa: not to approve the framework, disclose protected knowledge, select KILO, or authorize a build. Purple Maiʻa has not been sent it.</p></div>
      <div className="executive-grid">
        ...
        <article><span>What remains unanswered</span><h3>Whether the problem is real at all.</h3><p>That cannot be settled from public material. It would take a bounded, appropriately compensated discovery conversation with the people who hold standing—one that has not been requested, scheduled, or offered.</p></article>
      </div>
      ...
      <div className="review-room">
        <div className="review-room-head"><div><p className="overline">Reviewer response path · illustrative browser demonstration</p><h3>How direction could be recorded without accidentally granting permission.</h3></div><p>No response has been given by anyone. Use only non-sensitive notes. Download creates a discussion brief, not an authorization record.</p></div>
    ...
    <footer><div><span className="knot">◈</span><b>The Sovereign Stack</b><small>Version 1.0 · 6 August 2026</small></div><p>Independent, unsolicited analysis by Rayven-Nikkita (RN) Collins, written from Purple Maiʻa’s public material alone. It was not requested, commissioned, reviewed, endorsed, or seen by Purple Maiʻa, and no relationship or engagement of any kind exists between them. Not a Purple Maiʻa product, policy, endorsement, approved protocol, or community-authorized framework. <button onClick={openPrivacy} aria-controls="status-privacy-panel">Status, privacy &amp; erase drafts</button></p></footer>
  </main>;
}
